...
import { MeshInputs } from "../engine/geometry/inputs.js";
import { MeshOptions } from "../engine/geometry/options.js";
...
const mesh_inputs = new MeshInputs(1 /* position */ | 8 /* uv */);
...
(async () => {
    ...
    for (let vertex_id = 0; vertex_id < vertex_count; vertex_id++) {
        input_positions.addVertex(susan_positions[vertex_position_offset], susan_positions[vertex_position_offset + 1], susan_positions[vertex_position_offset + 2]);
        input_uvs.addVertex(susan_uvs[vertex_uv_offset], susan_uvs[vertex_uv_offset + 1]);
        vertex_uv_offset += 2;
