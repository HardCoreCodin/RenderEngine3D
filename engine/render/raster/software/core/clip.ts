import {CLIP, CULL, INEXTRA, INSIDE, NEAR} from "../../../../core/constants.js";
...
export const clipFaces = <FaceVerticesArrayType extends Uint8Array|Uint16Array|Uint32Array = Uint32Array>(
    ...
    near_clipping_plane_distance: number, pz: number,
    ...
    let v1_index, v1_flags, nx, d1_x, d2_x, new_v1x, new_v2x, in2x,
        v2_index, v2_flags, ny, d1_y, d2_y, new_v1y, new_v2y, in2y,
        v3_index, v3_flags, nz, d1_z, d2_z, new_v1z, new_v2z, in2z,
        new_v2num, out1_index, out1_num, out1z, in1_index, in1_num, in1z,
        new_v1num, out2_index, out2_num, out2z, in2_index, in2_num,
        t, one_minus_t, clipped_face_v1_index, clipped_index, component_count, one_over_length: number;
