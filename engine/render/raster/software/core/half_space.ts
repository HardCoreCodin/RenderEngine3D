...
import {IPixelShader, IPixel, ISurface, IPixelScene} from "../materials/shaders/pixel.js";
...
export const shadeFace1 = <Pixel extends IPixel, Shader extends IPixelShader<Pixel>>(
    shader: Shader,
