...
import {IPixelShader, IShaded} from "../materials/shaders/pixel.js";
import {dir3} from "../../../../accessors/direction.js";
import {ISize} from "../../../../core/interfaces/render.js";
import {Pixels} from "../../../../buffers/vectors.js";

export const projectVertex = (vertex: Float32Array, half_width: number, half_height: number) => {
...
export const shadeFace = <Shaded extends IShaded = IShaded, Shader extends IPixelShader<Shaded> = IPixelShader<Shaded>>(
    shader: Shader,
    shaded: IShaded,
    pixels: Pixels,
    image_size: ISize,
