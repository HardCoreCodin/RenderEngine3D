import { add_a_3D_vector_to_another_3D_vector_to_out, dot_a_3D_direction_with_another_3D_direction, multiply_a_3D_vector_by_a_number_and_add_another_vector_to_out, multiply_a_3D_vector_by_a_number_in_place, multiply_a_3D_vector_by_a_number_to_out, square_the_length_of_a_3D_direction, subtract_a_3D_vector_from_another_3D_vector_to_out } from "../../../../core/math/vec3.js";
export const intersectRayWithSpheres1 = (radii, centers, ROx, ROy, ROz, // The position that the ray originates from
RDx, RDy, RDz, // The direction that the ray is aiming at
hit_position, // The position of the closest intersection of the ray with the spheres
hit_normal // The direction of the surface of the sphere at the intersection position
) => {
...
export const intersectRayWithSpheres2 = (radii, centers, RO, // The position that the ray originates from
RD, // The direction that the ray is aiming at
hit_position, // The position of the closest intersection of the ray with the spheres
hit_normal // The direction of the surface of the sphere at the intersection position
) => {
    ...
    if (R) {
        if (R2_minus_D2 > 0.001)
            multiply_a_3D_vector_by_a_number_and_add_another_vector_to_out(RD, O2C - Math.sqrt(R2_minus_D2), RO, hit_position);
...
const intersectRayWithSpheres = (radii, centers, RO, // The position that the ray originates from
RDs, // The direction that the ray is aiming at
offset, hit_position, // The position of the closest intersection of the ray with the spheres
hit_normal // The direction of the surface of the sphere at the intersection position
) => {
    let r, r2, // The radius of the current sphere (and it's square)
    d, d2, // The distance from the origin to the position of the current intersection (and it's square)
...
//# sourceMappingURL=ray_sphere.js.map