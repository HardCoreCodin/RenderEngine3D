...
const getTempID = (): number => matrix4x4Buffer.allocateTemp();
...
const set_from = (a: number, o: number): void => {
    M11[a] = M11[o];  M12[a] = M12[o];  M13[a] = M13[o];  M14[a] = M14[o];
    M21[a] = M21[o];  M22[a] = M22[o];  M23[a] = M23[o];  M24[a] = M24[o];
    M31[a] = M31[o];  M32[a] = M32[o];  M33[a] = M33[o];  M34[a] = M34[o];
    M41[a] = M41[o];  M42[a] = M42[o];  M43[a] = M43[o];  M44[a] = M44[o];
};
...
const invert = (a: number, o: number) : void => {
    M14[o] = M14[a];  M11[o] = M11[a];  M12[o] = M21[a];  M13[o] = M31[a];  M23[o] = M32[a];
    M24[o] = M24[a];  M22[o] = M22[a];  M21[o] = M12[a];  M31[o] = M13[a];  M32[o] = M23[a];
    M34[o] = M34[a];  M33[o] = M33[a];
...
const invert_in_place = (a: number) : void => {
    ...
    t11 = M11[a];  t21 = M21[a];  t31 = M31[a];  t41 = M41[a];
    t12 = M12[a];  t22 = M22[a];  t32 = M32[a];  t42 = M42[a];
    t13 = M13[a];  t23 = M23[a];  t33 = M33[a];  t43 = M43[a];
...
const transpose = (a: number, o: number) : void => {
    M11[o] = M11[a];  M21[o] = M12[a];  M31[o] = M13[a];  M41[o] = M14[a];
    M12[o] = M21[a];  M22[o] = M22[a];  M32[o] = M23[a];  M42[o] = M24[a];
    M13[o] = M31[a];  M23[o] = M32[a];  M33[o] = M33[a];  M43[o] = M34[a];
    M14[o] = M41[a];  M24[o] = M42[a];  M34[o] = M43[a];  M44[o] = M44[a];
};
...
const is_identity = (a: number) : boolean =>
    M11[a] === 1  &&  M21[a] === 0  &&  M31[a] === 0  &&  M41[a] === 0 &&
...
const add = (a: number, b: number, o: number) : void => {
    M11[o] = M11[a] + M11[b];  M21[o] = M21[a] + M21[b];  M31[o] = M31[a] + M31[b];  M41[o] = M41[a] + M41[b];
    M12[o] = M12[a] + M12[b];  M22[o] = M22[a] + M22[b];  M32[o] = M32[a] + M32[b];  M42[o] = M42[a] + M42[b];
    M13[o] = M13[a] + M13[b];  M23[o] = M23[a] + M23[b];  M33[o] = M33[a] + M33[b];  M43[o] = M43[a] + M43[b];
    M14[o] = M14[a] + M14[b];  M24[o] = M24[a] + M24[b];  M34[o] = M34[a] + M34[b];  M44[o] = M44[a] + M44[b];
};

const add_in_place = (a: number, b: number) : void => {
    M11[a] += M11[b];  M21[a] += M21[b];  M31[a] += M31[b];  M41[a] += M41[b];
    M12[a] += M12[b];  M22[a] += M22[b];  M32[a] += M32[b];  M42[a] += M42[b];
    M13[a] += M13[b];  M23[a] += M23[b];  M33[a] += M33[b];  M43[a] += M43[b];
    M14[a] += M14[b];  M24[a] += M24[b];  M34[a] += M34[b];  M44[a] += M44[b];
};
...
const divide = (a: number, o: number, n: number) : void => {
    M11[o] = M11[a] / n;  M21[o] = M21[a] / n;  M31[o] = M31[a] / n;  M41[o] = M41[a] / n;
    M12[o] = M12[a] / n;  M22[o] = M22[a] / n;  M32[o] = M32[a] / n;  M42[o] = M42[a] / n;
    M13[o] = M13[a] / n;  M23[o] = M23[a] / n;  M33[o] = M33[a] / n;  M43[o] = M43[a] / n;
    M14[o] = M14[a] / n;  M24[o] = M24[a] / n;  M34[o] = M34[a] / n;  M44[o] = M44[a] / n;
};

const divide_in_place = (a: number, n: number) : void => {
    M11[a] /= n;  M21[a] /= n;  M31[a] /= n;  M41[a] /= n;
    M12[a] /= n;  M22[a] /= n;  M32[a] /= n;  M42[a] /= n;
    M13[a] /= n;  M23[a] /= n;  M33[a] /= n;  M43[a] /= n;
    M14[a] /= n;  M24[a] /= n;  M34[a] /= n;  M44[a] /= n;
};
...
const multiply_in_place = (a: number, b: number) : void => {
    ...
    t12 = M12[a];  t22 = M22[a];  t32 = M32[a];  t42 = M42[a];
    t13 = M13[a];  t23 = M23[a];  t33 = M33[a];  t43 = M43[a];
    t14 = M14[a];  t24 = M24[a];  t34 = M34[a];  t44 = M44[a];
