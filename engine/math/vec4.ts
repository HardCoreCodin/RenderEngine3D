...
import {Float4, Float16} from "../types.js";
import {IPosition4D, IDirection4D, IColor4D} from "./interfaces/classes.js";
import {IPositionFunctions, ICrossFunctions, IInterpolateFunctions, IVectorFunctions} from "./interfaces/functions.js";
...
export const update_matrix4x4_arrays = (MATRIX4x4_ARRAYS: Float16): Float16 => [
    M11, M12, M13, M14,
    M21, M22, M23, M24,
    M31, M32, M33, M34,
    M41, M42, M43, M44
...
const getTempID = (): number => vector4Dbuffer.allocateTemp();
