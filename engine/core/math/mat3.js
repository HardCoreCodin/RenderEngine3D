export const set_a_3x3_matrix_to_the_identity_matrix = (a) => {
    a[0] = a[4] = a[8] = 1;
    a[1] = a[2] = a[3] = a[5] = a[6] = a[7] = 0;
};
export const set_a_3x3_matrix_to_a_cross_product_matrix_for_a_3D_direction_in_place = (a, v) => {
    a[0] = a[4] = a[8] = 0;
    a[5] = v[0];
    a[7] = -v[0];
    a[6] = v[1];
...
export const set_a_3x3_matrix_to_an_outer_product_matrix_for_two_3D_directions_in_place = (a, v1, v2) => {
    a[0] = v1[0] * v2[0];
    a[1] = v1[1] * v2[0];
    a[2] = v1[2] * v2[0];
    a[3] = v1[0] * v2[1];
...
export const invert_a_3x3_matrix_to_out = (a, o) => {
    o[2] = a[2];
    o[0] = a[0];
    o[5] = a[5];
    o[4] = a[4];
...
export const invert_a_3x3_matrix_in_place = (a) => {
...
export const transpose_a_3x3_matrix_to_out = (a, o) => {
    o[0] = a[0];
    o[3] = a[1];
    o[6] = a[2];
    o[1] = a[3];
...
export const transpose_a_3x3_matrix_in_place = (a) => {
    [
...
export const check_if_two_3x3_matrices_are_equal = (a, b) => a[0].toFixed(3) === b[0].toFixed(3) &&
...
export const check_if_a_3x3_matrix_is_the_identity_matrix = (a) => a[0] === 1 && a[3] === 0 && a[6] === 0 &&
    a[1] === 0 && a[4] === 1 && a[7] === 0 &&
    a[2] === 0 && a[5] === 0 && a[8] === 1;
export const add_a_3x3_matrix_to_another_3x3_matrix_to_out = (a, b, o) => {
    o[0] = a[0] + b[0];
    o[3] = a[3] + b[3];
    o[6] = a[6] + b[6];
    o[1] = a[1] + b[1];
...
export const add_a_3x3_matrix_to_another_3x3_matrix_in_place = (a, b) => {
    a[0] += b[0];
    a[3] += b[3];
    a[6] += b[6];
    a[1] += b[1];
...
export const add_a_number_to_a_3x3_matrix_to_out = (a, b, o) => {
    o[0] = a[0] + b;
    o[3] = a[3] + b;
    o[6] = a[6] + b;
    o[1] = a[1] + b;
...
export const add_a_number_to_a_3x3_matrix_in_place = (a, b) => {
    a[0] += b;
    a[3] += b;
    a[6] += b;
    a[1] += b;
...
export const subtract_a_3x3_matrix_from_another_3x3_matrix_to_out = (a, b, o) => {
    o[0] = a[0] - b[0];
    o[3] = a[3] - b[3];
    o[6] = a[6] - b[6];
    o[1] = a[1] - b[1];
...
export const subtract_a_3x3_matrix_from_another_3x3_matrix_in_place = (a, b) => {
    a[0] -= b[0];
    a[3] -= b[3];
    a[6] -= b[6];
    a[1] -= b[1];
...
export const subtract_a_number_from_a_3x3_matrix_to_out = (a, b, o) => {
    o[0] = a[0] - b;
    o[3] = a[3] - b;
    o[6] = a[6] - b;
    o[1] = a[1] - b;
...
export const subtract_a_number_from_a_3x3_matrix_in_place = (a, b) => {
    a[0] -= b;
    a[3] -= b;
    a[6] -= b;
    a[1] -= b;
...
export const divide_a_3x3_matrix_by_a_number_to_out = (a, b, o) => {
    o[0] = a[0] / b;
    o[3] = a[3] / b;
    o[6] = a[6] / b;
    o[1] = a[1] / b;
...
export const divide_a_3x3_matrix_by_a_number_in_place = (a, b) => {
    a[0] /= b;
    a[3] /= b;
    a[6] /= b;
    a[1] /= b;
...
export const multiply_a_3x3_matrix_by_a_number_to_out = (a, b, o) => {
    o[0] = a[0] * b;
    o[3] = a[3] * b;
    o[6] = a[6] * b;
    o[1] = a[1] * b;
...
export const multiply_a_3x3_matrix_by_a_number_in_place = (a, b) => {
    a[0] *= b;
    a[3] *= b;
    a[6] *= b;
    a[1] *= b;
...
export const multiply_a_3x3_matrix_by_another_3x3_matrix_to_out = (a, b, o) => {
...
export const multiply_a_3x3_matrix_by_another_3x3_matrix_in_place = (a, b) => {
    const t11 = a[0];
    const t12 = a[1];
    const t13 = a[2];
    const t21 = a[3];
...
export const set_a_3x3_matrix_to_a_rotation_around_x_in_place = (a, sin, cos) => {
    a[8] = a[4] = cos;
    a[5] = -sin;
    a[7] = sin;
};
export const set_a_3x3_matrix_to_a_rotation_around_y_in_place = (a, sin, cos) => {
    a[0] = a[8] = cos;
    a[2] = sin;
    a[6] = -sin;
};
export const set_a_3x3_matrix_to_a_rotation_around_z_in_place = (a, sin, cos) => {
    a[0] = a[4] = cos;
    a[1] = -sin;
    a[3] = sin;
};
export const rotate_a_3x3_matrix_around_x_to_out = (a, sin, cos, o) => {
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_x_to_out = (a, sin, cos, o) => {
    o[0] = a[0];
    o[1] = a[1] * cos + a[2] * sin;
    o[2] = a[2] * cos - a[1] * sin;
    o[3] = a[3];
...
export const rotate_a_3x3_matrix_around_x_in_place = (a, sin, cos) => {
    // t11 t12 t13      r11 r12 r13
    // t21 t22 t23  *=  r21 r22 r23
    // t31 t32 t33      r31 r32 r33
    //
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_x_in_place = (a, sin, cos) => {
    const t12 = a[1];
    const t13 = a[2];
    const t22 = a[4];
    const t23 = a[5];
...
export const rotate_a_3x3_matrix_around_y_to_out = (a, sin, cos, o) => {
    // t11 t12 t13     r11 r12 r13
    // t21 t22 t23  *  r21 r22 r23
    // t31 t32 t33     r31 r32 r33
    //
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_y_to_out = (a, sin, cos, o) => {
    o[0] = a[0] * cos - a[2] * sin;
    o[1] = a[1];
    o[2] = a[0] * sin + a[2] * cos;
    o[3] = a[3] * cos - a[5] * sin;
...
export const rotate_a_3x3_matrix_around_y_in_place = (a, sin, cos) => {
    // t11 t12 t13      r11 r12 r13
    // t21 t22 t23  *=  r21 r22 r23
    // t31 t32 t33      r31 r32 r33
    //
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_y_in_place = (a, sin, cos) => {
    const t11 = a[0];
    const t13 = a[2];
    const t21 = a[3];
    const t23 = a[5];
...
export const rotate_a_3x3_matrix_around_z_to_out = (a, sin, cos, o) => {
    // t11 t12 t13     r11 r12 r13
    // t21 t22 t23  *  r21 r22 r23
    // t31 t32 t33     r31 r32 r33
    //
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_z_to_out = (a, sin, cos, o) => {
    o[0] = a[0] * cos + a[1] * sin;
    o[1] = a[1] * cos - a[0] * sin;
    o[2] = a[2];
    o[3] = a[3] * cos + a[4] * sin;
...
export const rotate_a_3x3_matrix_around_z_in_place = (a, sin, cos) => {
    // t11 t12 t13      r11 r12 r13
    // t21 t22 t23  *=  r21 r22 r23
    // t31 t32 t33      r31 r32 r33
    //
...
export const rotate_a_2x2_portion_of_a_3x3_matrix_around_z_in_place = (a, sin, cos) => {
    const t11 = a[0];
    const t12 = a[1];
    const t21 = a[3];
    const t22 = a[4];
