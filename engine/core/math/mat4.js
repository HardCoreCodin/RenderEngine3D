export const set_a_4x4_matrix_to_the_identity_matrix = (a) => {
    a[0] = a[5] = a[10] = a[15] = 1;
    a[1] = a[2] = a[3] =
        a[4] = a[6] = a[7] =
            a[8] = a[9] = a[11] =
...
export const invert_a_4x4_matrix_to_out_simple = (a, o) => {
    o[3] = a[3];
    o[0] = a[0];
    o[1] = a[4];
    o[2] = a[8];
...
export const invert_a_4x4_matrix_to_out = (a, o) => {
    const m11 = a[0], m21 = a[4], m31 = a[8], m41 = a[12], m12 = a[1], m22 = a[5], m32 = a[9], m42 = a[13], m13 = a[2], m23 = a[6], m33 = a[10], m43 = a[14], m14 = a[3], m24 = a[7], m34 = a[11], m44 = a[15];
...
export const invert_a_4x4_matrix_in_place = (a) => {
...
export const transpose_a_4x4_matrix_to_out = (a, o) => {
    o[0] = a[0];
    o[4] = a[1];
    o[8] = a[2];
    o[12] = a[3];
...
export const transpose_a_4x4_matrix_in_place = (a) => {
    [
...
export const check_if_two_4x4_matrices_are_equal = (a, b) => a[0].toFixed(3) === b[0].toFixed(3) &&
...
export const check_if_a_4x4_matrix_is_the_identity_matrix = (a) => a[0] === 1 && a[4] === 0 && a[8] === 0 && a[12] === 0 &&
    a[1] === 0 && a[5] === 1 && a[9] === 0 && a[13] === 0 &&
    a[2] === 0 && a[6] === 0 && a[10] === 1 && a[14] === 0 &&
    a[3] === 0 && a[7] === 0 && a[11] === 0 && a[15] === 1;
export const add_a_4x4_matrix_to_another_4x4_matrix_to_out = (a, b, o) => {
    o[0] = a[0] + b[0];
    o[4] = a[4] + b[4];
    o[8] = a[8] + b[8];
    o[12] = a[12] + b[12];
...
export const add_a_4x4_matrix_to_another_4x4_matrix_in_place = (a, b) => {
    a[0] += b[0];
    a[4] += b[4];
    a[8] += b[8];
    a[12] += b[12];
...
export const add_a_number_to_a_4x4_matrix_to_out = (a, b, o) => {
    o[0] = a[0] + b;
    o[4] = a[4] + b;
    o[8] = a[8] + b;
    o[12] = a[12] + b;
...
export const add_a_number_to_a_4x4_matrix_in_place = (a, b) => {
    a[0] += b;
    a[4] += b;
    a[8] += b;
    a[12] += b;
...
export const subtract_a_4x4_matrix_from_another_4x4_matrix_to_out = (a, b, o) => {
    o[0] = a[0] - b[0];
    o[4] = a[4] - b[4];
    o[8] = a[8] - b[8];
    o[12] = a[12] - b[12];
...
export const subtract_a_4x4_matrix_from_another_4x4_matrix_in_place = (a, b) => {
    a[0] -= b[0];
    a[4] -= b[4];
    a[8] -= b[8];
    a[12] -= b[12];
...
export const subtract_a_number_from_a_4x4_matrix_to_out = (a, b, o) => {
    o[0] = a[0] - b;
    o[4] = a[4] - b;
    o[8] = a[8] - b;
    o[12] = a[12] - b;
...
export const subtract_a_number_from_a_4x4_matrix_in_place = (a, b) => {
    a[0] -= b;
    a[4] -= b;
    a[8] -= b;
    a[12] -= b;
...
export const divide_a_4x4_matrix_by_a_number_to_out = (a, b, o) => {
    o[0] = a[0] / b;
    o[4] = a[4] / b;
    o[8] = a[8] / b;
    o[12] = a[12] / b;
...
export const divide_a_4x4_matrix_by_a_number_in_place = (a, b) => {
    a[0] /= b;
    a[4] /= b;
    a[8] /= b;
    a[12] /= b;
...
export const multiply_a_4x4_matrix_by_a_number_to_out = (a, b, o) => {
    o[0] = a[0] * b;
    o[4] = a[4] * b;
    o[8] = a[8] * b;
    o[12] = a[12] * b;
...
export const multiply_a_4x4_matrix_by_a_number_in_place = (a, b) => {
    a[0] *= b;
    a[4] *= b;
    a[8] *= b;
    a[12] *= b;
...
export const multiply_a_4x4_matrix_by_another_4x4_matrix_to_out = (a, b, o) => {
...
export const multiply_a_4x4_matrix_by_another_4x4_matrix_in_place = (a, b) => {
    const t11 = a[0];
    const t12 = a[1];
    const t13 = a[2];
    const t14 = a[3];
...
export const multiply_a_4x4_matrix_by_a_3x3_matrix_in_place = (a, b) => {
    const t11 = a[0];
    const t12 = a[1];
    const t13 = a[2];
    const t21 = a[4];
...
export const set_a_4x4_matrix_to_a_rotation_around_x_in_place = (a, sin, cos) => {
    a[10] = a[5] = cos;
    a[6] = sin;
    a[9] = -sin;
};
export const set_a_4x4_matrix_to_a_rotation_around_y_in_place = (a, sin, cos) => {
    a[0] = a[10] = cos;
    a[2] = sin;
    a[8] = -sin;
};
export const set_a_4x4_matrix_to_a_rotation_around_z_in_place = (a, sin, cos) => {
    a[0] = a[5] = cos;
    a[1] = sin;
    a[4] = -sin;
};
export const rotate_a_4x4_matrix_around_x_to_out = (a, sin, cos, o) => {
    ...
    o[7] = a[7];
    o[8] = a[8];
    o[9] = a[10] * sin + a[9] * cos;
    o[10] = a[10] * cos - a[9] * sin;
    o[11] = a[11];
    o[12] = a[12];
    o[13] = a[14] * sin + a[13] * cos;
    o[14] = a[14] * cos - a[13] * sin;
    o[15] = a[15];
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_x_to_out = (a, sin, cos, o) => {
    o[0] = a[0];
    o[1] = a[2] * sin + a[1] * cos;
    o[2] = a[2] * cos - a[1] * sin;
    o[3] = a[3];
...
export const rotate_a_4x4_matrix_around_x_in_place = (a, sin, cos) => {
    // t11 t12 t13 t14      r11 r12 r13 r14
    // t21 t22 t23 t24  *=  r21 r22 r23 r24
    // t31 t32 t33 t34      r31 r32 r33 r34
    // t41 t42 t43 t44      r41 r42 r43 r44
    ...
    a[6] = t23 * cos - t22 * sin;
    a[9] = t32 * cos + t33 * sin;
    a[10] = t33 * cos - t32 * sin;
    a[13] = t42 * cos + t43 * sin;
    a[14] = t43 * cos - t42 * sin;
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_x_in_place = (a, sin, cos) => {
    const t12 = a[1];
    const t13 = a[2];
    const t22 = a[5];
    const t23 = a[6];
...
export const rotate_a_4x4_matrix_around_y_to_out = (a, sin, cos, o) => {
    // t11 t12 t13 t14     r11 r12 r13 r14
    // t21 t22 t23 t24  *  r21 r22 r23 r24
    // t31 t32 t33 t34     r31 r32 r33 r34
    // t41 t42 t43 t44     r41 r42 r43 r44
    ...
    o[6] = a[4] * sin + a[6] * cos;
    o[7] = a[7];
    o[8] = a[8] * cos - a[10] * sin;
    o[9] = a[9];
    o[10] = a[8] * sin + a[10] * cos;
    o[11] = a[11];
    o[12] = a[12] * cos - a[14] * sin;
    o[13] = a[13];
    o[14] = a[12] * sin + a[14] * cos;
    o[15] = a[15];
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_y_to_out = (a, sin, cos, o) => {
    o[0] = a[0] * cos - a[2] * sin;
    o[1] = a[1];
    o[2] = a[0] * sin + a[2] * cos;
    o[3] = a[3];
...
export const rotate_a_4x4_matrix_around_y_in_place = (a, sin, cos) => {
    // t11 t12 t13 t14      r11 r12 r13 r14
    // t21 t22 t23 t24  *=  r21 r22 r23 r24
    // t31 t32 t33 t34      r31 r32 r33 r34
    // t41 t42 t43 t44      r41 r42 r43 r44
    ...
    a[6] = t21 * sin + t23 * cos;
    a[8] = t31 * cos - t33 * sin;
    a[10] = t31 * sin + t33 * cos;
    a[12] = t41 * cos - t43 * sin;
    a[14] = t41 * sin + t43 * cos;
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_y_in_place = (a, sin, cos) => {
    const t11 = a[0];
    const t13 = a[2];
    const t21 = a[4];
    const t23 = a[6];
...
export const rotate_a_4x4_matrix_around_z_to_out = (a, sin, cos, o) => {
    // t11 t12 t13 t14     r11 r12 r13 r14
    // t21 t22 t23 t24  *  r21 r22 r23 r24
    // t31 t32 t33 t34     r31 r32 r33 r34
    // t41 t42 t43 t44     r41 r42 r43 r44
    ...
    o[10] = a[10];
    o[11] = a[11];
    o[12] = a[12] * cos + a[13] * sin;
    o[13] = a[13] * cos - a[12] * sin;
    o[14] = a[14];
    o[15] = a[15];
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_z_to_out = (a, sin, cos, o) => {
    o[0] = a[0] * cos + a[1] * sin;
    o[1] = a[1] * cos - a[0] * sin;
    o[2] = a[2];
    o[3] = a[3];
...
export const rotate_a_4x4_matrix_around_z_in_place = (a, sin, cos) => {
    // t11 t12 t13 t14      r11 r12 r13 r14
    // t21 t22 t23 t24  *=  r21 r22 r23 r24
    // t31 t32 t33 t34      r31 r32 r33 r34
    // t41 t42 t43 t44      r41 r42 r43 r44
    ...
    a[8] = t31 * cos + t32 * sin;
    a[9] = t32 * cos - t31 * sin;
    a[12] = t41 * cos + t42 * sin;
    a[13] = t42 * cos - t41 * sin;
};
export const rotate_a_3x3_portion_of_a_4x4_matrix_around_z_in_place = (a, sin, cos) => {
    const t11 = a[0];
    const t12 = a[1];
    const t21 = a[4];
    const t22 = a[5];
