...
export abstract class UInt8Allocator extends Allocator<Uint8Array> {
    protected _getArrayConstructor(): TypedArrayConstructor<Uint8Array> {return Uint8Array}
}
export class UInt8Allocator1D extends UInt8Allocator {constructor() {super(DIM._1D)}}
export class UInt8Allocator2D extends UInt8Allocator {constructor() {super(DIM._2D)}}
export class UInt8Allocator3D extends UInt8Allocator {constructor() {super(DIM._3D)}}

export abstract class UInt16Allocator extends Allocator<Uint16Array> {
    protected _getArrayConstructor(): TypedArrayConstructor<Uint16Array> {return Uint16Array}
}
export class UInt16Allocator1D extends UInt16Allocator {constructor() {super(DIM._1D)}}
export class UInt16Allocator2D extends UInt16Allocator {constructor() {super(DIM._2D)}}
export class UInt16Allocator3D extends UInt16Allocator {constructor() {super(DIM._3D)}}

export abstract class UInt32Allocator extends Allocator<Uint32Array> {
    protected _getArrayConstructor(): TypedArrayConstructor<Uint32Array> {return Uint32Array}
}

export class UInt32Allocator1D extends UInt32Allocator {constructor() {super(DIM._1D)}}
export class UInt32Allocator2D extends UInt32Allocator {constructor() {super(DIM._2D)}}
export class UInt32Allocator3D extends UInt32Allocator {constructor() {super(DIM._3D)}}
export class UInt32Allocator4D extends UInt32Allocator {constructor() {super(DIM._4D)}}

export abstract class Int32Allocator extends Allocator<Int32Array> {
    protected _getArrayConstructor(): TypedArrayConstructor<Int32Array> {return Int32Array}
}
