...
import {shadePixelBarycentric, shadePixelDepth} from "../lib/render/raster/software/materials/shaders/pixel.js";
...
inputs.sanitize();
const mesh_options = new MeshOptions(attributes, NORMAL_SOURCING.LOAD_VERTEX__NO_FACE, 0, true);
