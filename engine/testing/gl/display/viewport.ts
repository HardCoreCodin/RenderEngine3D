...
import {IGLBuffer, IGLUniform} from "../types.js";

import {BaseViewport} from "../../../lib/render/viewport.js";
import {Color4D} from "../../../lib/accessors/color.js";


export class GLViewport extends BaseViewport<WebGL2RenderingContext, GLCamera, GLScene, GLRenderPipeline> {
