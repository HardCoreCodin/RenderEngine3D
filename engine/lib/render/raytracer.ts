...
import {RayTraceScene} from "../scene_graph/scene.js";
import {RayTraceViewport} from "./viewport.js";
import {Canvas2DRenderPipeline} from "./pipelines.js";
...
export class RayTracer extends Canvas2DRenderPipeline<Camera, RayTraceScene, RayTraceViewport> {
    ...
    protected _generateRays(width: number, height: number, camera: Camera): void {
