...
export abstract class TransformableVector2D extends Vector2D implements ITransformableVector<Matrix2x2> {
    mul(num: number, out?: this): this;
    mul(other: this, out?: this): this;
    mul(matrix: Matrix2x2, out?: this): this;
    mul(matrix_or_other_or_num: Matrix2x2|this|number, out?: this): this {
        if (out && !out.is(this)) {
            ...
            } else if (matrix_or_other_or_num instanceof Matrix2x2) {
